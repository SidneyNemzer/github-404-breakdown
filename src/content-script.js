...
const IS_404_PAGE = !!document.querySelector(
...
if (IS_404_PAGE) {
  ...
  document
    .querySelector(
      "body > div.application-main.d-flex.flex-auto.flex-column > main > div.position-relative"
    )
    .insertAdjacentElement("afterend", container);

  // Figure out when the URL 404'd
  segments
    .reduce((previous, segment, index) => {
            ...
            if (segments[2] === "blob") {
              const treeUrl =
                ...
                segments
                  ...
                  .join("/");
              return fetch(treeUrl).then(res2 => {
                // Yep, this is a tree
                if (res2.ok) {
